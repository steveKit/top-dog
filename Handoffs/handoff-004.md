...
[[Handoffs/handoff-003]] (do not re-read the full M1 arc there). This session
...
- `Handoffs/handoff-003.md` — prettier-fix only (no content change).
- `CLAUDE.md` — Project Map latest-handoff pointer → handoff-004 (this
  bookkeeping).
- `memory/MEMORY.md` — appended the "prettier-format markdown before it lands"

...
- `PROJECT.md`, `CLAUDE.md`, `README.md`, `tasks/discovered.md` (DW-034 + DW-031 context),
  `tasks/milestone-08-snacktum-snacktorum-rebrand.md` — **MODIFIED** per-PR this session
  (not duplicated in this handoff).
- `CLAUDE.md` — **MODIFIED** (this handoff): Project Map "Latest handoff" pointer →
  `[[Handoffs/handoff-018]]`.
- `Handoffs/handoff-018.md` — **NEW** (this file).
...
App Chrome rebuild) was captured in [[tasks/discovered]] by its bookkeeping PR #120 as it
...
- [[tasks/milestone-08-snacktum-snacktorum-rebrand]] — the re-scoped M8 spec: the **§ Slug
...
See [[Handoffs/handoff-017]] for prior session context (the M8 build kickoff — auth surface +
onboarding rite).

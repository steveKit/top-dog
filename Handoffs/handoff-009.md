...
- `memory/MEMORY.md` — MODIFIED (this handoff): two new cross-session patterns.
- `CLAUDE.md` — MODIFIED (this handoff): Project Map latest-handoff pointer →
  `[[Handoffs/handoff-009]]`.
- `Handoffs/handoff-009.md` — NEW (this file).
...
Open items, all small, tracked in [[tasks/discovered]]:
...
1. **[P2] Activate M4 — Mustard Mechanic** — the next milestone, pre-exploded at
   [[tasks/milestone-04-mustard-mechanic]]: Top Dog sprays mustard, render-time
...
- [[tasks/milestone-04-mustard-mechanic]] — the next milestone.
...
See [[Handoffs/handoff-008]] for prior session context.

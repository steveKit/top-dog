...
**Phase:** M0–M7 complete · **M8 (Snacktum Snacktorum rebrand) — BUILDING** (activated 2026-06-19; TASK-087 theme + TASK-080 app shell complete, 2/10)
...
helper's 8 cases). Next up is the auth cluster (TASK-082 sign-in / TASK-083 reset) or
TASK-081 (copy). **All design questions are now RESOLVED:** the ritual sign-up rite, the
...
auto-pause risk; see Process notes). M8 adds nothing to that gate.

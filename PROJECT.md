...
[[Handoffs/INDEX]]) and relocated the design artifacts from repo-root `design/` →
...
task status changed, **no new decision row — the table stays at #29**. See [[Handoffs/handoff-021]].

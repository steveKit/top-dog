...
- `PROJECT.md`, `CLAUDE.md`, `README.md`, `workflow/tasks/discovered.md` (DW-035/036/037/038),
  `workflow/tasks/milestone-08-snacktum-snacktorum-rebrand.md` — **MODIFIED** per-PR this session (not
  duplicated in this handoff).
- `CLAUDE.md` — **MODIFIED** (this handoff): Project Map "Latest handoff" pointer →
  `[[workflow/handoffs/handoff-019]]`.
- `workflow/handoffs/handoff-019.md` — **NEW** (this file).
...
Four NEW items were logged this session (all captured in [[workflow/tasks/discovered]] as they landed). The
...
Prioritized — see [[TASKS]] and [[workflow/tasks/milestone-08-snacktum-snacktorum-rebrand]] for full context:
...
- [[workflow/tasks/milestone-08-snacktum-snacktorum-rebrand]] — the re-scoped M8 spec: the **§ Slug Map**
...
See [[workflow/handoffs/handoff-018]] for prior session context (the slug refactor + The Procession + the
App Chrome rebuild).

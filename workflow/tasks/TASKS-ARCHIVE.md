# Task Archive — Top Dog

> New completed milestones now freeze in their own `workflow/tasks/milestone-NN-*.md` files;
> this archive holds the pre-migration completed milestones (M0, M1).
...
**Discovered during this task:** DW-002
...
**Discovered during this task:** DW-004
...
**Discovered during this task:** DW-005
...
**Discovered during this task:** DW-007

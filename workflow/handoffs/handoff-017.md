...
- **The rebuild-from-design + re-slug pivot (PR #111) is the operating model for the rest
  ...
  **deviates from the original "URL paths UNCHANGED" plan** — in-app URLs now DO change —
  ...
  [[workflow/tasks/milestone-08-snacktum-snacktorum-rebrand]] § Slug Map.
...
- `workflow/tasks/milestone-08-snacktum-snacktorum-rebrand.md` — **MODIFIED** (PR #111 re-scope +
...
- `CLAUDE.md` — **MODIFIED** (this handoff): Project Map "Latest handoff" pointer →
  `[[workflow/handoffs/handoff-017]]`. (Convention/gotcha edits — the rite control flow, the
...
- `workflow/handoffs/handoff-017.md` — **NEW** (this file).
...
Two **process notes** (recurring, from prior sessions; both already in [[workflow/memory/MEMORY]]):
...
in [[workflow/tasks/discovered]] by their per-task bookkeeping as they landed. The fresh / updated
...
- [[workflow/tasks/milestone-08-snacktum-snacktorum-rebrand]] — the re-scoped M8 spec: the HARD
...
See [[workflow/handoffs/handoff-016]] for prior session context (the M8 scope + design phase).

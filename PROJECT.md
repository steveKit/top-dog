...
migration, no new dependency, no new architecture-decision row** (table stays #28). **Next:
TASK-093 (The Shrine) or another per-page rebuild.** **All design questions are now RESOLVED:** the ritual sign-up rite, the
